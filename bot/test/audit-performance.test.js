...
(async () => {
  ...
  // Regression ceilings with headroom over the post-fix measured sizes
  // (73463/89950/87137/97951 bytes at the time this oracle was written —
  // see 04-QA-Evidence/Audit-Fixes-2026-09-06/performance/after.json).
  // Pre-fix sizes were 74882/91360/88344/100516 — these ceilings sit
  // between "minified" and "unminified" so a silent revert of the CSS
  // minifier in scripts/build-builder.js still fails this check.
  const HEAVY_JS_CEILING_BYTES = {
    'product-menu': 82000,
    'local-service': 98000,
    portfolio: 96000,
    professionals: 106000,
  };

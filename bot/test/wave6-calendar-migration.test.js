...
// v4 wave, and the M2 owner-CRUD audit (2026-09) added a v6 migration
// (calendar_services.price_amount_cents/price_currency) on top of that —
// opening any pre-v6 database now advances all the way to 6. Every
// assertion below still targets the exact v4 columns/defaults this oracle
// was written to guard; only the final schema_migrations version number
// changed as a mechanical consequence of later waves existing.

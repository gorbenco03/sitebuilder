...
/* Meta chips at the fold — never enter FAB or cookie corners. The selector
 * used to name a separate credibility band; that band duplicated the hero's
 * own chips and was removed, so the clearance follows the chips to where they
 * actually live now. */
.pr-hero__meta {
...
/* While consent is open, keep the chips OFF the first screen under fixed

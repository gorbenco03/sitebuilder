...
(function () {
    ...
    // Labels from template data-lb-* on <html> (fall back to EN if missing).
    const root = document.documentElement;
    const lbCloseAria = root.getAttribute('data-lb-close') || 'Close';
    const lbPrevAria  = root.getAttribute('data-lb-prev')  || 'Previous';
    const lbNextAria  = root.getAttribute('data-lb-next')  || 'Next';
